...
const getActionCategory = (action) => {
  const categoryMap = {
    ...
    UPDATE_STOREFRONT_BUNDLES: 'COURSE_MANAGEMENT',
    ...
    // Quiz Module actions
    MODULE_CREATED: 'MODULE_MANAGEMENT',
    MODULE_UPDATED: 'MODULE_MANAGEMENT',
    MODULE_DELETED: 'MODULE_MANAGEMENT',
    MODULE_RESTORED: 'MODULE_MANAGEMENT',
    MODULE_PERMANENTLY_DELETED: 'MODULE_MANAGEMENT',
    QUIZZES_ADDED_TO_MODULE: 'MODULE_MANAGEMENT',
    QUIZ_REMOVED_FROM_MODULE: 'MODULE_MANAGEMENT',
